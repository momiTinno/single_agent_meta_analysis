...
function storeFor(run) { return { load: async () => run, savePending: async (_id, value) => Object.assign(run, value), completeAction: async (_id, value) => Object.assign(run, value, { pendingAction: null, step: run.step + 1 }), fail: async (_id, error) => Object.assign(run, { status: "failed", error }) }; }
